    ...
    return (
        <div className='flex flex-wrap gap-5 justify-between p-3 items-center'>
            ...
            {Object.entries(mapStyles).map(([name, url]) => (
                <button key={name} onClick={() => setStyle(url)} className="bg-white px-3 py-1 rounded shadow hover:bg-gray-200">
                    {name}
                </button>
            ))}
            ...
            <div className="min-w-[200px]">
                <Select
                    ...
                    value={estadoOptions.find(e => e.value === ufSelecionado) || null}
                />
